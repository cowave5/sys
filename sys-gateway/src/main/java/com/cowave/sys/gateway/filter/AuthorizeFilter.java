...
public class AuthorizeFilter implements GlobalFilter, Ordered {
    ...
    private String getAccessIp(ServerHttpRequest httpRequest) {
        String ip = getFirstNonUnknown(
                httpRequest.getHeaders().getFirst("X-Real-IP"),
                httpRequest.getHeaders().getFirst("x-forwarded-for"),
                httpRequest.getHeaders().getFirst("Proxy-Client-IP"),
                httpRequest.getHeaders().getFirst("X-Forwarded-For"),
                httpRequest.getHeaders().getFirst("WL-Proxy-Client-IP")
        );
