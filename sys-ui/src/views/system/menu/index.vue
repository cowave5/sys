<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                   :disabled="!checkPermit(['sys:menu:create'])">{{$t('commons.button.create')}}</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
                   :disabled="!checkPermit(['sys:menu:export'])">{{$t('commons.button.export')}}</el-button>
      </el-col>
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="menuList" row-key="menuId"
      ...
      <el-table-column prop="createTime" :label="$t('commons.label.date.create')" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('commons.label.options')" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                     :disabled="!checkPermit(['sys:menu:delete'])">{{$t('commons.button.delete')}}</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
          ...
          <el-col :span="12" v-if="form.menuType !== 'B'">
            <el-form-item>
              ...
              <el-radio-group v-model="form.isFrame">
                <el-radio v-for="dict in dict.type.menu_frame" :key="dict.value" :label="dict.value">{{$t(dict.name)}}</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.menuType !== 'B'">
            <el-form-item>
              ...
              <el-radio-group v-model="form.isVisible">
                <el-radio v-for="dict in dict.type.show_hide" :key="dict.value" :label="dict.value">{{$t(dict.name)}}</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="12" v-if="form.menuType === 'M'">
            <el-form-item>
              ...
              <el-radio-group v-model="form.isProtected">
                <el-radio v-for="dict in dict.type.public_protected" :key="dict.value" :label="dict.value">{{$t(dict.name)}}</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.menuType !== 'B'">
          ...
          <el-col :span="12" v-if="form.menuType === 'C'">
            <el-form-item>
              ...
              <el-radio-group v-model="form.isCache">
                <el-radio v-for="dict in dict.type.menu_cache" :key="dict.value" :label="dict.value">{{$t(dict.name)}}</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm"
                   :disabled="!checkPermit(['sys:menu:edit'])">{{$t('commons.button.confirm')}}</el-button>
