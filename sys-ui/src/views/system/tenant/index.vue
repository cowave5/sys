<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" @submit.native.prevent v-show="showSearch" label-width="68px">
      <el-form-item label="租户标识" prop="tenantName">
    ...
    <el-table :data="list" @selection-change="handleSelectionChange"
      ...
      <el-table-column label="租户标识" align="center" prop="tenantId" :show-overflow-tooltip="true" />
      <el-table-column label="租户名称" align="center" prop="tenantName" :show-overflow-tooltip="true" />
      <el-table-column label="租户地址" align="center" prop="tenantAddr" />
      <el-table-column label="人员规模" align="center" prop="userCount" >
        <template slot-scope="scope">
          <span>{{ scope.row.userCount }} / {{ scope.row.userLimit }}</span>
        </template>
      </el-table-column>
      <el-table-column label="状态" prop="tenantStatus" align="center" width="60">
        <template slot-scope="scope">
      ...
      <el-table-column label="到期时间" align="center" prop="createTime" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('commons.label.options')" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                     :disabled="scope.row.tenantId === 'system' || !checkPermit(['sys:tenant:edit'])">
            {{$t('commons.button.edit')}}
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          <el-col :span="12">
            <el-row>
              ...
              <el-col :span="24">
                <el-form-item label="租户标题" prop="title">
          ...
          <el-col :span="12">
            <el-form-item label="租户Logo" prop="logo">
              <imageUpload v-model="imageUrl" tenantId="sys-tenant" ownerType="sys-tenant" attachType="logo"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="人员规模" prop="userLimit">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="联系人" prop="tenantUser">
              <el-input v-model="form.tenantUser"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="联系地址" prop="tenantAddr">
...
import {addTenant, getTenant, getTenantList} from "@/api/system/tenant";
  ...
  computed: {
    rules() {
      return {
        ...
        title: [
          { required: true, message: "租户标题不能为空", trigger: "blur" }
        ],
        tenantName: [
