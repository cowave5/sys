<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :header-cell-style="{'text-align':'center'}">
      ...
      <el-table-column label="日志描述" align="center" prop="opDesc" width="180" :show-overflow-tooltip="true" />
      <el-table-column label="访问ip" align="center" prop="ip"/>
      <el-table-column label="访问路径" align="left" prop="url" width="200" :show-overflow-tooltip="true" />
