...
import com.cowave.sys.admin.core.controller.SysUserController;
...
public class SysUserControllerTest extends SpringTest {
    ...
    public void add() throws Exception {
        mockPost("/api/v1/user", "{\"userAccount\":\"test\",\"userName\":\"测试人员\",\"userPasswd\":\"123456\"}");
    }
    ...
    public void edit() throws Exception {
        mockPatch("/api/v1/user", "{\"userId\":5,\"userAccount\":\"test\",\"userName\":\"测试人员\",\"userPasswd\":\"123456\"}");
    }
    ...
    public void changeStatus() throws Exception {
        mockPatch("/api/v1/user/status", "{\"userId\":5,\"userName\":\"test\",\"userStatus\":0}");
    }
    ...
    public void changePasswd() throws Exception {
        mockPatch("/api/v1/user/passwd", "{\"userId\":5,\"userName\":\"test\",\"userPasswd\":\"123123\"}");
    }
    ...
    public void changeRoles() throws Exception {
        mockPatch("/api/v1/user/roles", "{\"userId\":5,\"userName\":\"test\",\"roleIds\": [1,2]}");
    }
    ...
    public void changeReadonly() throws Exception {
        mockPatch("/api/v1/user/readonly", "{\"userId\":5,\"userName\":\"test\",\"readOnly\":1}");
    }
