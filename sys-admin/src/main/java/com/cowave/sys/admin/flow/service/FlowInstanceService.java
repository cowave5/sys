 ...
 */
package com.cowave.sys.admin.flow.service;

import com.cowave.commons.client.http.response.Response;
import com.cowave.commons.framework.access.Access;
import com.cowave.sys.admin.rabc.infra.dao.mapper.dto.SysUserDtoMapper;
import com.cowave.sys.admin.flow.domain.FlowExecution;
import com.cowave.sys.admin.flow.domain.FlowInstance;
import com.cowave.sys.admin.flow.domain.FlowTask;
import com.cowave.sys.admin.flow.domain.FlowVariable;
import com.cowave.sys.admin.flow.infra.mapper.FlowExecutionMapper;
...
public class FlowInstanceService {
    ...
    public Response.Page<FlowInstance> list(FlowInstance flowInstance) {
        ...
        if(flowInstance.isActive()){
            ...
            processList.forEach(process -> {
                ...
                instance.setStartUserName(sysUserMapper.queryNameById(Integer.valueOf(process.getStartUserId())));
                ...
                for(Task task : taskList){
                    ...
                    flowTask.setAssigneeName(sysUserMapper.queryNameById(Integer.valueOf(task.getAssignee())));
            ...
            historyList.forEach(history -> {
                ...
                instance.setStartUserName(sysUserMapper.queryNameById(Integer.valueOf(history.getStartUserId())));
    ...
    public Response.Page<FlowTask> history(String id) {
        ...
        historyList.forEach( history -> {
            ...
            task.setAssigneeName(sysUserMapper.queryNameById(Integer.valueOf(history.getAssignee())));
