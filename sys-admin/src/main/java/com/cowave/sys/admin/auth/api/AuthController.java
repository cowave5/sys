 ...
 */
package com.cowave.sys.admin.auth.api;
...
import com.cowave.sys.admin.auth.domain.AuthInfo;
...
import com.cowave.sys.admin.base.domain.vo.OnlineUser;
import com.cowave.sys.admin.rabc.domain.vo.Route;
...
public class AuthController {
    ...
    public Response<AuthInfo> info() throws Exception {
        ...
        if(AccessUserDetails.TYPE_OAUTH.equals(userDetails.getType())){
            ...
            SysAttachDto avatar = attachService.latestOfMaster(Long.valueOf(userId), "sys-user");
            if(avatar != null){
