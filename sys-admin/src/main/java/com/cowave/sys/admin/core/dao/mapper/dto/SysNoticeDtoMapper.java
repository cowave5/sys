...
public interface SysNoticeDtoMapper {
     ...
     * 用户创建的
     */
    Page<SysNoticeDto> listOfUser(Page<SysNoticeDto> page, @Param("userId") Long userId, @Param("notice") SysNoticeDto sysNotice);
     ...
     * 消息列表
     */
    Page<SysNoticeDto> msgList(Page<SysNoticeDto> page, @Param("userId") Long userId);
