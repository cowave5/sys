 ...
 */
package com.cowave.sys.admin.base.api;
...
import com.cowave.sys.admin.base.domain.dto.SysAlarmTypeDto;
import com.cowave.sys.admin.base.domain.vo.AlarmHandles;
...
public class SysAlarmController {
    ...
    public Response<SysAlarmDto> info(@NotNull(message = "{valid.notnull.alarm.id}") Long id) {
