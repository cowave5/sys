...
import com.cowave.sys.admin.auth.UserNotFoundException;
...
import com.cowave.sys.admin.core.entity.vo.RouteMeta;
import com.cowave.sys.admin.core.service.SysMenuService;
...
public class AuthService {
    ...
    public String register(RegisterUser registerUser) {
        String initPasswd = sysRedisHelper.getConfig("sys.user.initPassword");
