...
import com.cowave.sys.admin.core.dao.mapper.dto.SysNoticeDtoMapper;
import com.cowave.sys.admin.core.dao.mapper.dto.SysUserDtoMapper;
import com.cowave.sys.admin.core.entity.dto.SysAttachDto;
import com.cowave.sys.admin.core.entity.dto.SysNoticeDto;
import com.cowave.sys.admin.core.entity.dto.SysNoticeReadDto;
...
public class SysNoticeServiceImpl implements SysNoticeService {
    ...
    public void msgRead(Long noticeId) {
        if(sysNoticeMapper.msgRead(noticeId, SysNoticeReadDto.STATUS_PUBLISH_READ, Access.userId(v -> ((Number)v).longValue()), Access.accessTime()) > 0){
