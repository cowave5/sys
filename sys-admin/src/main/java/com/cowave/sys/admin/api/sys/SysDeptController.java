...
import com.cowave.sys.admin.service.sys.SysDeptService;
import com.cowave.sys.admin.core.cache.SysDeptCache;
...
public class SysDeptController {
    ...
    private final SysDeptCache sysDeptCache;
    ...
    public Response<List<Tree<String>>> tree(String deptId) {
        return Response.success(sysDeptCache.tree(deptId));
    }
     ...
     * 新增
     */
    @Operation(type = "admin_dept", action = "add", desc = "新增部门：#{#sysDept.deptName}", handleExpr = "#opHandler.logRequest(#opInfo)")
     ...
     * 修改
     */
    @Operation(type = "admin_dept", action = "edit", desc = "修改部门：#{#resp.deptName}", handleExpr = "#opHandler.logAll(#opInfo, #sysDept, #resp)")
     ...
     * @param deptId 部门id
     */
    @Operation(type = "admin_dept", action = "delete", desc = "删除部门", handleExpr = "#opHandler.logResponse(#opInfo, #resp)")
     ...
     * 修改只读
     */
    @Operation(type = "admin_dept", action = "readonly", desc = "修改部门[#{#sysDept.deptName}]只读状态", handleExpr = "#opHandler.logRequest(#opInfo)")
