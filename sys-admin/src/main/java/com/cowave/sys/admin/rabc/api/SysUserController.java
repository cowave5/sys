 ...
 */
package com.cowave.sys.admin.rabc.api;
...
import static com.cowave.sys.admin.base.infra.SysOperationHandler.*;
...
public class SysUserController {
    ...
    @GetMapping
    public Response<Response.Page<SysUserListDto>> list(SysUserQuery query) {
    ...
    @PostMapping
    public Response<Void> create(@Validated @RequestBody SysUserCreate user) throws Exception {
    ...
    @PatchMapping
    public Response<Void> edit(@Validated @RequestBody SysUserCreate user) throws Exception {
    ...
    @PatchMapping("/roles")
    public Response<Void> changeRoles(@Validated @RequestBody SysUserRoleUpdate roleUpdate) throws Exception {
    ...
    @PreAuthorize("@permit.hasPermit('sys:user:edit')")
    @PatchMapping("/status")
    public Response<Void> changeStatus(@Validated @RequestBody SysUserStatusUpdate statusUpdate) throws Exception {
    ...
    @PatchMapping("/passwd")
    public Response<Void> changePasswd(@Validated @RequestBody SysUserPasswdUpdate passwdUpdate) throws Exception {
    ...
    public Response<Void> changeReadonly(@Validated @RequestBody SysUserReadUpdate readUpdate) throws Exception {
        return Response.success(() -> sysUserService.changeReadonly(readUpdate));
    }
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, SysUserExport userExport) throws Exception {
        ...
        EasyExcel.write(response.getOutputStream(), SysUser.class).sheet("用户")
                .registerWriteHandler(new CellWidthHandler()).doWrite(sysUserService.listForExport(userExport));
    }
    ...
    public Response<Void> refresh() throws Exception {
        return Response.success(sysUserService::refreshUserTree);
    }
