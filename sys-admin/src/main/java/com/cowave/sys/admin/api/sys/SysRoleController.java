...
import com.cowave.sys.admin.service.sys.SysRoleService;
...
public class SysRoleController {
     ...
     * 新增
     */
    @Operation(type = "admin_role", action = "add", desc = "新增角色：#{#sysRole.roleName}", handleExpr = "#opHandler.logRequest(#opInfo)")
    @PostMapping("/add")
     ...
     * 修改
     */
    @Operation(type = "admin_role", action = "edit", desc = "修改角色：#{#sysRole.roleName}", handleExpr = "#opHandler.logAll(#opInfo, #sysRole, #resp)")
    @PostMapping("/edit")
     ...
     * @param roleId 角色id
     */
    @Operation(type = "admin_role", action = "delete", desc = "删除角色", handleExpr = "#opHandler.logResponse(#opInfo, #resp)")
    @GetMapping("/delete")
     ...
     * 修改只读
     */
    @Operation(type = "admin_role", action = "readonly", desc = "修改角色[#{#sysRole.roleName}]只读状态", handleExpr = "#opHandler.logRequest(#opInfo)")
