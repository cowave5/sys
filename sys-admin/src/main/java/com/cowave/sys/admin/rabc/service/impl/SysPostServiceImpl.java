...
import com.cowave.sys.admin.rabc.infra.redis.SysPostRedis;
import com.cowave.sys.admin.rabc.service.SysPostService;
...
public class SysPostServiceImpl implements SysPostService {
    ...
    public List<SysPostDto> delete(Long[] postId) {
        Asserts.isTrue(sysPostMapper.countUserByIdArray(postId) == 0, "{post.forbid.delete.hasuser}");
        Asserts.isTrue(sysPostMapper.countReadOnlyByIdArray(postId) == 0, "{post.forbid.delete.readonly}");
