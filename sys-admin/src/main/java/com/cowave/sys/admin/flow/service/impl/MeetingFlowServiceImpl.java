...
import com.cowave.sys.admin.flow.domain.Meeting;
import com.cowave.sys.admin.flow.infra.mapper.FlowMeetingMapper;
import com.cowave.sys.admin.flow.service.MeetingFlowService;
...
public class MeetingFlowServiceImpl implements MeetingFlowService {
    ...
    public void add(Meeting meeting) {
        ...
        meeting.setApplyUser(Access.userId(v -> ((Number)v).longValue()));
