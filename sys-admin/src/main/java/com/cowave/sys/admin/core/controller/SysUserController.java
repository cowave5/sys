...
public class SysUserController {
	...
	public Response<SysUserInfoDto> info(@PathVariable Long userId) {
	...
	@PatchMapping
	public Response<SysUserInfoDto> edit(@Validated @RequestBody UserCreate user) {
	...
	public Response<List<SysUserInfoDto>> delete(@PathVariable List<Long> userIds) {
	...
	public Response<Void> changeRoles(@Validated @RequestBody UserRoleUpdate roleUpdate) {
		sysUserService.changeRoles(roleUpdate);
		return Response.success();
	}
	...
	public Response<Void> changeStatus(@Validated @RequestBody UserStatusUpdate statusUpdate) {
		sysUserService.changeStatus(statusUpdate);
		return Response.success();
	}
	...
	public Response<Void> changePasswd(@Validated @RequestBody UserPasswdUpdate passwdUpdate) {
		sysUserService.changePasswd(passwdUpdate);
		return Response.success();
	}
	...
	public Response<Void> changeReadonly(@Validated @RequestBody UserReadUpdate readUpdate) {
		sysUserService.changeReadonly(readUpdate);
		return Response.success();
	}
	...
	public Response<Void> refresh() throws Exception {
		sysUserService.refreshUserTree();
		return Response.success();
	}
	 ...
	 */
	@GetMapping("/leaders")
	public Response<List<SysUserDto>> leaders(Long userId) {
