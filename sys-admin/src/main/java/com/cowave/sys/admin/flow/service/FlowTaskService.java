...
import com.cowave.sys.admin.core.service.SysNoticeService;
import com.cowave.sys.admin.flow.entity.FlowTask;
import com.cowave.sys.admin.flow.entity.TaskComplete;
...
public class FlowTaskService {
    ...
    public Response.Page<FlowTask> listHistory(FlowTask flowTask) {
        ...
        tasks.forEach(t -> {
            ...
            task.setAssigneeName(sysUserMapper.queryNameById(Integer.valueOf(t.getAssignee())));
            ...
            if(process != null){
                ...
                task.setStarterName(sysUserMapper.queryNameById(Integer.valueOf(process.getStartUserId())));
                ...
                task.setStarterName(sysUserMapper.queryNameById(Integer.valueOf(historyProcess.getStartUserId())));
    ...
    public List<FlowTask> records(String taskId) {
        ...
        activityHistory.forEach(activity -> {
            if("userTask".equals(activity.getActivityType())){
                ...
                flowTask.setAssigneeName(sysUserMapper.queryNameById(Integer.valueOf(activity.getAssignee())));
    ...
    public void press(String taskId) {
        ...
        sysNoticeService.sendFlowNotice(process.getProcessDefinitionName(), task.getName(),
                Integer.valueOf(process.getStartUserId()), Long.valueOf(task.getAssignee()));
    }
