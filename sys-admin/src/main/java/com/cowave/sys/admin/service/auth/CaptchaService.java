...
public class CaptchaService {
    ...
    public CaptchaInfo captcha() throws IOException {
        ...
        boolean registerOnOff = sysConfigCache.getValue("sys.account.registerOnOff");
        boolean captchaOnOff = sysConfigCache.getValue("sys.account.captchaOnOff");
        if (!captchaOnOff) {
        ...
        // 生成验证码
        String captchaType = sysConfigCache.getValue("sys.account.captchaType");
