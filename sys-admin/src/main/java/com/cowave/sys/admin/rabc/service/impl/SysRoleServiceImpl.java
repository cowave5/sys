...
import com.cowave.sys.admin.rabc.domain.dto.RoleUserDto;
import com.cowave.sys.admin.rabc.domain.dto.SysRoleDto;
import com.cowave.sys.admin.rabc.domain.vo.UserAuthed;
import com.cowave.sys.admin.rabc.service.SysRoleService;
...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    @Override
    public SysRoleDto info(Integer roleId) {
    ...
    public void add(SysRoleDto sysRole) {
    	...
    	Asserts.isTrue(codeCount == 0, "{role.conflict.code}", sysRole.getRoleCode());
    	// 新增角色
    ...
    public List<SysRoleDto> delete(Long[] roleId) {
        Asserts.isTrue(sysRoleMapper.countReadOnlyByIdArray(roleId) == 0, "{role.forbid.delete.readonly}");
    ...
    @Override
    public Page<RoleUserDto> userAuthed(UserAuthed userAuthed) {
        return sysRoleMapper.userAuthed(Access.page(), userAuthed);
    }

    @Override
    public Page<RoleUserDto> userUnAuthed(UserAuthed userAuthed) {
        return sysRoleMapper.userUnAuthed(Access.page(), userAuthed);
    }
