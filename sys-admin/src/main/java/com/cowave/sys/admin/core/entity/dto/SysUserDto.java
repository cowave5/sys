...
public class SysUserDto extends AccessInfo {
	 ...
	 * 用户部门
	 */
	private List<SysUserDeptDto> deptList;
	 ...
	 * 上级用户
	 */
	private List<SysUserParentDto> parentList;
	...
	public Long getDeptId() {
		...
		for(SysUserDeptDto dept : deptList){
