...
import com.cowave.sys.admin.core.dao.mapper.dto.SysMenuDtoMapper;
...
public class SysMenuServiceImpl implements SysMenuService {
	...
	public List<SysMenuDto> list(String menuName, Integer menuStatus, Integer visible, boolean filterRole) {
		...
		return sysMenuMapper.userMenus(Access.userId(v -> ((Number)v).longValue()), visible, menuName, menuStatus);
	}

	@Override
	public List<SysMenuDto> oauthMenus(Long userId) {
