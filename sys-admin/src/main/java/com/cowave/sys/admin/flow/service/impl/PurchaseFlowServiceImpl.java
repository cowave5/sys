...
import com.cowave.sys.admin.flow.domain.Purchase;
import com.cowave.sys.admin.flow.infra.mapper.FlowPurchaseMapper;
import com.cowave.sys.admin.flow.service.PurchaseFlowService;
...
public class PurchaseFlowServiceImpl implements PurchaseFlowService {
    ...
    public Page<Purchase> list(Purchase purchase) {
        ...
        for(Purchase p : list){
            ...
            if(activeTask != null){
                ...
                p.setProcessTaskUser(sysUserMapper.queryNameById(Integer.valueOf(activeTask.getAssignee())));
            }
        }
        return page;
    }
    ...
    public void add(Purchase purchase) {
        ...
        variables.put("starter", Access.userId(v -> ((Number)v).longValue()));
        ...
        purchase.setApplyUser(Access.userId(v -> ((Number)v).longValue()));
