...
--菜单数据
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (0, 'commons.menu.sys.root', 1, NULL, 'system', NULL, 'M', 'system', NULL, 1, 1, 1, 1, 1, '系统管理目录', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2023-08-29 02:04:32.684');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (0, 'commons.menu.monitor', 2, NULL, 'monitor', NULL, 'M', 'monitor', NULL, 1, 1, 1, 1, 1, '系统监控目录', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2023-08-09 07:02:51.069');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (0, 'commons.menu.tool', 3, NULL, 'tool', NULL, 'M', 'tool', NULL, 1, 1, 1, 1, 1, '系统工具目录', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2023-08-29 02:10:56.743');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (0, 'commons.menu.cowave', 9, NULL, 'https://www.cowave.com/', NULL, 'C', 'guide', NULL, 1, 0, 1, 1, 0, '控维官网', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2023-08-10 06:45:14.541');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (1, 'commons.menu.sys.user', 1, 'sys:user:query', 'user', NULL, 'C', 'user', 'system/user/index', 1, 1, 1, 1, 1, '用户管理菜单', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2023-08-29 02:04:54.33');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (1, 'commons.menu.sys.role', 4, 'sys:role:query', 'role', NULL, 'C', 'peoples', 'system/role/index', 1, 1, 1, 1, 1, '角色管理菜单', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2023-08-29 02:07:43.946');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (1, 'commons.menu.sys.menu', 5, 'sys:menu:query', 'menu', NULL, 'C', 'tree-table', 'system/menu/index', 1, 1, 1, 1, 1, '菜单管理菜单', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (1, 'commons.menu.sys.dept', 2, 'sys:dept:query', 'dept', NULL, 'C', 'tree', 'system/dept/index', 1, 1, 1, 1, 1, '部门管理菜单', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2023-08-29 02:06:04.739');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (1, 'commons.menu.sys.post', 3, 'sys:post:query', 'post', NULL, 'C', 'post', 'system/post/index', 1, 1, 1, 1, 1, '岗位管理菜单', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (1, 'commons.menu.sys.dict', 6, 'sys:dict:query', 'dict', NULL, 'C', 'dict', 'system/dict/index', 1, 1, 1, 1, 1, '字典管理菜单', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (1, 'commons.menu.sys.config', 7, 'sys:config:query', 'config', NULL, 'C', 'edit', 'system/config/index', 1, 1, 1, 1, 1, '参数设置菜单', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_menu (parent_id, menu_name, menu_order, menu_permit, menu_path, menu_param, menu_type, menu_icon, component, menu_status, is_frame, is_cache, is_visible, is_protected, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES (0, 'commons.menu.notice', 4, '', 'notice', NULL, 'C', 'message', 'system/notice/index', 1, 1, 1, 1, 0, '通知公告菜单', 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2023-08-15 16:07:25.603');
...
--字典数据
INSERT INTO sys_dict (parent_code, dict_code, dict_label, dict_en, dict_value, value_parser, value_param, dict_order, is_default, css, status, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES ('root', 'group', '字典分组', 'Dict Group', 'group', NULL, NULL, 0, 0, NULL, 1, NULL, 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_dict (parent_code, dict_code, dict_label, dict_en, dict_value, value_parser, value_param, dict_order, is_default, css, status, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES ('group', 'sys', '系统字典', 'sys dict', 'sys', NULL, NULL, 1, 0, NULL, 1, NULL, 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_dict (parent_code, dict_code, dict_label, dict_en, dict_value, value_parser, value_param, dict_order, is_default, css, status, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES ('sys', 'sys_is_success', '是否成功', 'Success/Failed', 'sys_is_success', NULL, NULL, 2, 0, NULL, 1, NULL, 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_dict (parent_code, dict_code, dict_label, dict_en, dict_value, value_parser, value_param, dict_order, is_default, css, status, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES ('sys', 'sys_is_enable', '是否启用', 'Enable/Disable', 'sys_is_enable', NULL, NULL, 2, 0, NULL, 1, NULL, 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_dict (parent_code, dict_code, dict_label, dict_en, dict_value, value_parser, value_param, dict_order, is_default, css, status, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES ('sys', 'sys_is_protected', '是否受保护的', 'Public/Protected', 'sys_is_protected', NULL, NULL, 2, 0, NULL, 1, NULL, 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_dict (parent_code, dict_code, dict_label, dict_en, dict_value, value_parser, value_param, dict_order, is_default, css, status, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES ('sys', 'sys_yes_no', '是否', 'Yes/No', 'sys_yes_no', NULL, NULL, 2, 0, NULL, 1, NULL, 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
INSERT INTO sys_dict (parent_code, dict_code, dict_label, dict_en, dict_value, value_parser, value_param, dict_order, is_default, css, status, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES ('sys', 'sys_show_hide', '显示隐藏', 'Show/Hide', 'sys_show_hide', NULL, NULL, 2, 0, NULL, 1, NULL, 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
...
INSERT INTO sys_role (role_code, role_name, role_type, remark, read_only, create_user, create_dept, create_time, update_user, update_dept, update_time) VALUES ('user-readonly', '只读用户', 'sys', NULL, 0, 1, NULL, '2022-04-25 09:00:00', 1, NULL, '2022-04-25 09:00:00');
