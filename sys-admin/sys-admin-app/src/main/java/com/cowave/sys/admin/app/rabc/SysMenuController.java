...
public class SysMenuController{
	...
	public Response<Void> updateReadonly(@Validated @RequestBody MenuReadUpdate menuUpdate) throws Exception {
		return Response.success(() -> sysMenuService.updateReadonly(menuUpdate));
	}
