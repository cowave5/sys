...
public class SysDictController {
	...
	public Response<Void> updateReadonly(@RequestBody DictReadUpdate dictUpdate) throws Exception {
		return Response.success(() -> sysDictService.updateReadonly(dictUpdate));
	}
