...
public class SysScopeController {
	 ...
	 * 列表
	 */
	@PreAuthorize("@permit.hasPermit('sys:scope:query')")
	@GetMapping
     ...
     * 新增
     */
    @PreAuthorize("@permit.hasPermit('sys:scope:create')")
    @PostMapping
     ...
     * 删除
     */
    @PreAuthorize("@permit.hasPermit('sys:scope:delete')")
     ...
     * 修改
     */
    @PreAuthorize("@permit.hasPermit('sys:scope:edit')")
    @PatchMapping
     ...
     * 修改状态
     */
    @PreAuthorize("@permit.hasPermit('sys:scope:status')")
    @PatchMapping("/status")
