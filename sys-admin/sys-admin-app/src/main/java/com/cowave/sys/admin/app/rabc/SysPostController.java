...
public class SysPostController {
	 ...
	 * 修改只读
	 */
	@Operation(type = "admin_post", action = "readonly", desc = "修改岗位[#{#postUpdate.postName}]只读状态", flag = REQ)
	@PreAuthorize("@permit.hasPermit('sys:common:readonly')")
	@PatchMapping("/readonly")
	public Response<Void> updateReadonly(@Validated @RequestBody PostReadUpdate postUpdate) throws Exception {
		return Response.success(() -> sysPostService.updateReadonly(postUpdate));
	}
