...
public class SysPostController {
     ...
     * 部门岗位名称查询
     */
    @GetMapping("/name/{deptPosts}")
    public Response<List<String>> getNames(@PathVariable List<String> deptPosts) {
        return Response.success(sysPostService.getNames(deptPosts));
    }
}
