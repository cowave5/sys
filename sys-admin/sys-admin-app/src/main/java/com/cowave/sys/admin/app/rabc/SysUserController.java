...
public class SysUserController {
     ...
     * 修改角色
     */
    @Operation(module = "op_admin", type = "op_user", action = "op_grant", desc = "修改用户'#{#user.userName}'角色")
     ...
     * 修改状态
     */
    @Operation(module = "op_admin", type = "op_user", action = "op_status", desc = "修改用户'#{#user.userName}'状态")
     ...
     * 修改密码
     */
    @Operation(module = "op_admin", type = "op_user", action = "op_passwd", desc = "修改用户'#{#user.userName}'密码")
    ...
    public Response<List<String>> getNames(@PathVariable List<Integer> userIds) {
        return Response.success(sysUserService.getNames(userIds));
    }
}
