...
public class SysDeptRedis implements ApplicationRunner {
    private static final String KEY_DEPT = "admin:tree:dept";
    private static final String KEY_DEPT_USER = "admin:tree:dept-user";
    private static final String KEY_DEPT_POST = "admin:tree:dept-post";
