...
public class SysDictDao extends ServiceImpl<SysDictMapper, SysDict> {
    ...
    public long countReadOnlyByIds(List<Integer> dictIds){
        return lambdaQuery().eq(SysDict::getReadOnly, 1).in(SysDict::getId, dictIds).count();
    }
    ...
    public void updateDict(DictInfoDto sysDict){
        lambdaUpdate().eq(SysDict::getId, sysDict.getId())
                ...
                .set(SysDict::getDictLabel, sysDict.getDictLabel())
                .set(SysDict::getDictEn, sysDict.getDictEn())
                ...
                .set(SysDict::getValueParam, sysDict.getValueParam())
    ...
    public void updateReadonly(Integer dictId, Integer readonly){
        lambdaUpdate().eq(SysDict::getId, dictId)
                .set(SysDict::getUpdateBy, Access.userCode())
                .set(SysDict::getUpdateTime, new Date())
                .set(SysDict::getReadOnly, readonly)
                .update();
    }
