...
public class SysDeptDao extends ServiceImpl<SysDeptMapper, SysDept> {
    ...
    public void updateDept(DeptCreate dept){
        lambdaUpdate().eq(SysDept::getDeptId, dept.getDeptId())
                .set(SysDept::getUpdateUser, Access.userId())
                .set(SysDept::getUpdateDept, Access.deptId())
     ...
     * 修改部门只读
     */
    public void updateReadonly(Integer deptId, Integer readonly){
        lambdaUpdate().eq(SysDept::getDeptId, deptId)
                .set(SysDept::getUpdateUser, Access.userId())
                .set(SysDept::getUpdateDept, Access.deptId())
                .set(SysDept::getUpdateTime, new Date())
                .set(SysDept::getReadOnly, readonly)
                .update();
    }
}
