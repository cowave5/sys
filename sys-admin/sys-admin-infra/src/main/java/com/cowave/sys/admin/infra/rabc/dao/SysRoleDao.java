...
public class SysRoleDao extends ServiceImpl<SysRoleMapper, SysRole> {
    ...
    public long countReadOnlyByRoleIds(List<Integer> roleIds){
        return lambdaQuery().eq(SysRole::getReadOnly, 1).in(SysRole::getRoleId, roleIds).count();
    }
    ...
    public void updateRole(SysRole sysRole){
        lambdaUpdate().eq(SysRole::getRoleId, sysRole.getRoleId())
                .set(SysRole::getUpdateUser, Access.userId())
                .set(SysRole::getUpdateDept, Access.deptId())
    ...
    public void updateReadonly(Integer roleId, Integer readonly){
        lambdaUpdate().eq(SysRole::getRoleId, roleId)
                .set(SysRole::getUpdateUser, Access.userId())
                .set(SysRole::getUpdateDept, Access.deptId())
                .set(SysRole::getUpdateTime, new Date())
                .set(SysRole::getReadOnly, readonly)
                .update();
    }
}
