...
import static com.cowave.sys.admin.domain.rabc.enums.UserType.LDAP;
...
public class LdapServiceImpl implements LdapService {
    ...
    public AccessUserDetails authenticate(String userAccount, String passWord) {
        ...
        ldapUserDtoMapper.insertUpdateUser(ldapUser);

        String roleCode = ldapUserDao.getRoleCodeByAccount(ldapUser.getUserAccount());
        List<String> permits;
    ...
    private LdapTemplate getLdapTemplate(LdapConfig ldapConfig){
        ...
        try{
            ...
            throw new HttpException(e, BAD_REQUEST, "{ldap.invalid}");
        }
    ...
    public void validConfig(LdapConfig ldapConfig) {
        ...
        try{
            ...
            throw new HttpException(e, BAD_REQUEST, "{ldap.failed.exception}");
        }
        if(list.isEmpty()){
            throw new HttpException(BAD_REQUEST, "{ldap.failed.user}");
        }
    }
