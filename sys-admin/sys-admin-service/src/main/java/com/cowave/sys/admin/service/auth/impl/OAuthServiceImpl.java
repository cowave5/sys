...
public class OAuthServiceImpl implements OAuthService {
    private static final String PREFIX = "sys-admin:token:code:";
    ...
    public AccessUserDetails gitlabCallback(String code) {
        ...
        GitlabToken gitlabToken = restTemplate.postForObject(GITLAB.getTokenUrl(oAuthServer, code), null, GitlabToken.class);
        ...
        ResponseEntity<GitlabUser> response =
                restTemplate.exchange(GITLAB.getUserUrl(oAuthServer), HttpMethod.GET, entity, GitlabUser.class);
