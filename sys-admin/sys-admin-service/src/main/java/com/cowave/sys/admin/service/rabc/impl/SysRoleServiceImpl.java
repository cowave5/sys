...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    public void add(SysRole sysRole) {
    	...
    	// 新增角色
        sysRole.setCreateInfo(Access.accessInfo());
    ...
    public void delete(List<Integer> roleIds) {
        ...
        Asserts.isTrue(readOnlyCount == 0, "{role.forbid.delete.readonly}");
    ...
    public void updateMenus(RoleMenuUpdate roleUpdate) {
        ...
        Asserts.notNull(preRole, "{role.notexist}", roleUpdate.getRoleId());
        Asserts.notEquals(1, preRole.getReadOnly(), "{role.forbid.edit.readonly}", preRole.getRoleName());
