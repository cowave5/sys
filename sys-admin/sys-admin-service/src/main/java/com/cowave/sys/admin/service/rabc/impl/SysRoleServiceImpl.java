...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    public void delete(List<Integer> roleIds) {
        long readOnlyCount = sysRoleDao.countReadOnlyByRoleIds(roleIds);
        HttpAsserts.isTrue(readOnlyCount == 0, FORBIDDEN, "{role.forbid.delete.readonly}");
    ...
    public void edit(SysRole sysRole) {
    	...
    	HttpAsserts.notEquals(1, FORBIDDEN, preRole.getReadOnly(), "{role.forbid.edit.readonly}", preRole.getRoleName());
    ...
    @Override
    public void updateReadonly(RoleReadUpdate roleUpdate) {
        sysRoleDao.updateReadonly(roleUpdate.getRoleId(), roleUpdate.getReadOnly());
    }
    ...
    public void updateMenus(RoleMenuUpdate roleUpdate) {
        ...
        HttpAsserts.notEquals(1, preRole.getReadOnly(), FORBIDDEN, "{role.forbid.edit.readonly}", preRole.getRoleName());
