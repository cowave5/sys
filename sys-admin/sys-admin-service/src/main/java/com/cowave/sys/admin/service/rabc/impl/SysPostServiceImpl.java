...
import com.cowave.sys.admin.domain.rabc.request.PostReadUpdate;
...
public class SysPostServiceImpl implements SysPostService {
    ...
    public void delete(List<Integer> postIds) {
        ...
        long postCount = sysPostDao.countReadOnlyByPostIds(postIds);
        HttpAsserts.isTrue(postCount == 0, FORBIDDEN, "{post.forbid.delete.readonly}");
    ...
    public void edit(PostInfoDto sysPost) {
        ...
        HttpAsserts.notEquals(1, prePost.getReadOnly(), FORBIDDEN, "{post.forbid.edit.readonly}", prePost.getPostName());
    ...
    @Override
    public void updateReadonly(PostReadUpdate postUpdate) {
        sysPostDao.updateReadonly(postUpdate.getPostId(), postUpdate.getReadOnly());
    }
