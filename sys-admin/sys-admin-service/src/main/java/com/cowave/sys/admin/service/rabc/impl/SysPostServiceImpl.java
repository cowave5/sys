...
public class SysPostServiceImpl implements SysPostService {
    ...
    public void add(PostInfoDto sysPost) {
        // 新增岗位
        sysPost.setCreateInfo(Access.accessInfo());
    ...
    public void delete(List<Integer> postIds) {
        ...
        Asserts.isTrue(postUserCount == 0, "{post.forbid.delete.hasuser}");

        long postCount = sysPostDao.countReadOnlyByPostIds(postIds);
        Asserts.isTrue(postCount == 0, "{post.forbid.delete.readonly}");
