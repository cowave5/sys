...
public class SysDeptServiceImpl implements SysDeptService {
    ...
    public void delete(List<Integer> deptIds) {
        HttpAsserts.isTrue(sysDeptDao.countReadOnlyByIds(deptIds) == 0, FORBIDDEN, "{dept.forbid.delete.readonly}");
    ...
    public void edit(DeptCreate deptCreate) {
        ...
        HttpAsserts.isTrue(preDept.getReadOnly() == 0, FORBIDDEN, "{dept.forbid.edit.readonly}");
    ...
    @Override
    public void updateReadonly(DeptReadUpdate deptUpdate) {
        sysDeptDao.updateReadonly(deptUpdate.getDeptId(), deptUpdate.getReadOnly());
    }
